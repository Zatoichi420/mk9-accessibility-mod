...
REM resources until it sees MKKE.exe appear, then starts talking. No Steam
...
echo will speak as soon as it detects Mortal Kombat Komplete Edition. Just launch the game
