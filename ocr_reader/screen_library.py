...
aspect ratio, no letterboxing on one but not the other). If this game's UI
has any animated/ambient background behind static menu text (both Legacy
Kollection's launcher and MKX did), the same "roi" fix documented for
those projects likely applies here too - see their screen_library.py
history if this comes up.
