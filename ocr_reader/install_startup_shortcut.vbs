...
Set shortcut = shell.CreateShortcut(startupFolder & "\MK9 Accessibility Reader.lnk")
shortcut.TargetPath = "wscript.exe"
shortcut.Arguments = """" & scriptDir & "\start_reader.vbs"""
shortcut.WorkingDirectory = scriptDir
shortcut.Description = "Starts the Mortal Kombat Komplete Edition accessibility reader quietly in the background"
shortcut.Save
